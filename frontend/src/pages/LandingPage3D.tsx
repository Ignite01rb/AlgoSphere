  ...
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="landingLogoGrad" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
        <stop stopColor="hsl(36, 96%, 48%)" />
        <stop offset="0.5" stopColor="hsl(30, 95%, 45%)" />
        <stop offset="1" stopColor="hsl(15, 90%, 50%)" />
      </linearGradient>
    </defs>
    <circle cx="12" cy="12" r="9" stroke="url(#landingLogoGrad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="2.5 2.5" />
    <path d="M12 3C14.5 6 14.5 18 12 21" stroke="url(#landingLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M12 3C9.5 6 9.5 18 12 21" stroke="url(#landingLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="3" y1="12" x2="21" y2="12" stroke="url(#landingLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="12" cy="3" r="1.5" fill="currentColor" className="text-foreground" />
    <circle cx="12" cy="21" r="1.5" fill="currentColor" className="text-foreground" />
    <circle cx="12" cy="12" r="2" fill="url(#landingLogoGrad)" />
    <circle cx="3" cy="12" r="1" fill="currentColor" className="text-muted-foreground/60" />
    <circle cx="21" cy="12" r="1" fill="currentColor" className="text-muted-foreground/60" />
  </svg>
);
