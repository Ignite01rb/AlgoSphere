...
export const AlgoSphereLogo = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="12" cy="12" r="9" stroke="url(#navLogoGrad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="2.5 2.5" />
    <path d="M12 3C14.5 6 14.5 18 12 21" stroke="url(#navLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M12 3C9.5 6 9.5 18 12 21" stroke="url(#navLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="3" y1="12" x2="21" y2="12" stroke="url(#navLogoGrad)" strokeWidth="1.5" strokeLinecap="round" />
    ...
    <circle cx="12" cy="12" r="2" fill="url(#navLogoGrad)" />
